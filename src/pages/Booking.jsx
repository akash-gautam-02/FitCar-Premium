        ...
        >
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="text-right">
              <span className="label-sm text-primary opacity-60 tracking-[0.3em] uppercase">
                Phase 0{step}
              </span>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
              ...
              >
                ...
                <div className="glass-card p-10 rounded-[2.5rem] relative overflow-hidden group">
                  <div className="relative z-10 space-y-4">
                    ...
                    <h2 className="display-md normal-case leading-none text-on-surface">
                      {carName}
                    </h2>
                  </div>
                ...
                <section className="space-y-8">
                  <div className="flex items-center gap-3 opacity-40">
                    <User size={16} />
                    <h3 className="label-md uppercase tracking-widest">
                ...
                <section className="space-y-8">
                  ...
                  <div className="flex gap-4 overflow-x-auto pb-4 custom-scrollbar">
                    {dates.map((item, idx) => (
                      ...
                      >
                        <span className="label-sm font-bold uppercase mb-2 tracking-tighter">
                          {item.day}
                        </span>
                        <span className="display-sm font-black text-2xl leading-none">
                          {item.date}
                        </span>
                      </motion.div>
                    ))}
                ...
                <div className="glass-card p-10 rounded-[3rem] border border-white/5 space-y-10 relative overflow-hidden">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center py-4 border-b border-white/5">
                        <span className="body-md text-on-surface/40">
                          Unit Model
                        </span>
                        <span className="headline-sm italic text-on-surface">
                          {carName}
                        </span>
                      </div>
                      <div className="flex justify-between items-center py-4 border-b border-white/5">
                        ...
                        <span className="body-lg text-primary">
                          {formData.fullName}
                        </span>
                      </div>
                      <div className="flex justify-between items-center py-4 border-b border-white/5">
                        ...
                        <span className="body-lg text-on-surface">
                          {formData.email}
                        </span>
                      </div>
                  ...
                  <div className="p-6 bg-primary/5 border border-primary/20 rounded-2xl flex items-center gap-4">
                    ...
                    <p className="label-sm text-primary/60 uppercase tracking-widest leading-relaxed">
                      Identity verification required upon arrival at the
                      manufacturing hub.
                    </p>
                  </div>
                </div>
          ...
          <div className="pt-12 space-y-6">
            ...
            <div className="flex items-center justify-center gap-2 opacity-30">
              ...
              <p className="label-sm uppercase tracking-[0.2em]">
                Quantum SSL Encrypted Transaction
              </p>
            </div>
          </div>
        </form>
