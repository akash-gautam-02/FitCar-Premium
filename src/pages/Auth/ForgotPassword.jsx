              ...
              >
                <header className="space-y-6 text-center">
                  <div className="flex flex-col items-center gap-6 mb-8">
                    ...
                    <span className="label-sm font-black tracking-[0.4em] text-on-surface/30 uppercase italic">
                      IDENTITY_RECOVERY v2.4
                    </span>
                  </div>
                  ...
                  <p className="label-md text-on-surface/40 uppercase tracking-widest leading-relaxed max-w-md mx-auto">
                    Enter your operational ID to re-authenticate secure access
                    to the Kinetic Terminal.
                  </p>
                </header>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center px-4">
                      <label className="label-sm text-secondary uppercase tracking-[0.4em] font-black">
                        Registered ID
                      </label>
                ...
                <div className="pt-12 border-t border-white/5 flex flex-col items-center gap-8">
                  <Link
                    to="/login"
                    className="flex items-center gap-4 label-sm font-black tracking-widest text-on-surface/30 hover:text-primary transition-all uppercase group"
                  >
                    <ArrowLeft
                      size={16}
              ...
              >
                <div className="flex flex-col items-center space-y-10">
                  ...
                  <div className="space-y-6">
                    <h2 className="display-sm normal-case italic text-on-surface leading-tight">
                      Signal{" "}
                      <span className="text-primary not-italic">Sent</span>
                    </h2>
                    <p className="label-md text-on-surface/40 uppercase tracking-[0.2em] leading-loose max-w-sm mx-auto font-bold">
                      Mission-grade recovery key has been transmitted to your
                ...
                <div className="space-y-6 pt-8 border-t border-white/5">
                  <Link to="/login" className="block">
                    <Button
                      variant="ghost"
                      className="w-full h-16 rounded-[2rem] border-white/5 hover:border-primary/40 text-xs font-black tracking-widest uppercase transition-all backdrop-blur-xl group"
                    >
                  ...
                  <div className="pt-4">
                    <p className="label-sm text-on-surface/20 font-bold tracking-widest uppercase hover:text-primary transition-all cursor-pointer">
                      Still locked out?{" "}
                      <span className="text-secondary italic ml-2">
                        Open Emergency Comms Channel
                      </span>
                    </p>
                  </div>
                </div>
