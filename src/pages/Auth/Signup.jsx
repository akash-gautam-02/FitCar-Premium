...
const signupSchema = z.object({
  ...
  terms: z
    .boolean()
    .refine((val) => val === true, "Mission protocols must be accepted"),
});
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center overflow-hidden p-20">
        ...
        <div className="relative z-10 max-w-lg space-y-12">
          ...
          <div className="space-y-6">
            ...
            >
              Join The <br />
              <span className="text-secondary not-italic">Kinetic Fleet</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Access the most advanced performance ecosystem in automotive
              history. Neural-linked telemetry, predictive engineering, and
              exclusive ownership protocols.
            </motion.p>
          </div>
          ...
          >
            <div className="space-y-3 p-8 glass-card rounded-3xl border border-white/5">
              ...
              <div>
                <h4 className="label-sm text-primary uppercase tracking-widest font-black">
                  Neural Uplink
                </h4>
                <p className="text-[10px] text-on-surface/30 uppercase mt-1 leading-relaxed">
                  Real-time biometrics & vehicle syncing
                </p>
              </div>
            </div>
            <div className="space-y-3 p-8 glass-card rounded-3xl border border-white/5">
              ...
              <div>
                <h4 className="label-sm text-secondary uppercase tracking-widest font-black">
                  Global Grid
                </h4>
                <p className="text-[10px] text-on-surface/30 uppercase mt-1 leading-relaxed">
                  Priority access to worldwide track protocols
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="w-full max-w-lg">
          ...
          >
            <div className="space-y-2">
              <h2 className="headline-md normal-case italic text-on-surface leading-none">
                Create{" "}
                <span className="text-secondary not-italic">Identity</span>
              </h2>
              <p className="label-sm text-on-surface/30 uppercase tracking-[0.4em] font-black">
                New operative enrollment protocol
              </p>
            </div>
            <div className="flex gap-3">
              <div
                className={`h-1.5 w-10 rounded-full transition-all duration-500 ${step === 1 ? "bg-primary shadow-luxury-neon" : "bg-white/5"}`}
              ></div>
              <div
                className={`h-1.5 w-10 rounded-full transition-all duration-500 ${step === 2 ? "bg-primary shadow-luxury-neon" : "bg-white/5"}`}
              ></div>
            </div>
          </motion.div>
              ...
              {step === 1 ? (
                ...
                >
                  <div className="space-y-3">
                    <label className="label-sm text-on-surface/30 uppercase tracking-[0.3em] font-black ml-1">
                      Full Identity Name
                    </label>
                    <div className="relative group/input">
                      <User
                        className="absolute left-6 top-1/2 -translate-y-1/2 text-on-surface/20 group-focus-within/input:text-primary transition-all duration-500"
                        size={18}
                      />
                      <input
                        {...register("fullName")}
                      ...
                      />
                      {errors.fullName && (
                        <p className="text-[10px] text-secondary font-bold uppercase tracking-widest absolute -bottom-6 left-2">
                  ...
                  <div className="p-8 glass-card rounded-[2.5rem] border border-white/5 space-y-6 mt-12 relative overflow-hidden group/terms">
                    ...
                    <div className="flex items-start gap-6 relative z-10">
                      <div className="relative flex items-center">
                        ...
                        <CheckCircle2
                          size={16}
                          className="absolute left-1 text-black opacity-0 peer-checked:opacity-100 transition-all pointer-events-none"
                        />
                      </div>
                      <label
                        htmlFor="terms"
                        className="label-sm lowercase font-bold leading-relaxed text-on-surface/40 cursor-pointer select-none"
                      >
                        I acknowledge and accept all missions protocols,
                        biometric data anonymization policies, and global
                        service terms.
                      </label>
                    </div>
                    {errors.terms && (
                      <p className="text-[10px] text-secondary font-bold uppercase tracking-widest absolute -bottom-1 right-8">
          ...
          <div className="mt-16 text-center">
            <p className="label-sm text-on-surface/40 font-bold tracking-widest uppercase">
              ...
              <Link
                to="/login"
                className="text-secondary hover:text-primary hover:underline ml-2 transition-all italic"
              >
                Initialize Session
              </Link>
            </p>
