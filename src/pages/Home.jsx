    ...
    <div className="bg-background text-on-surface overflow-x-hidden font-inter">
      ...
      <section className="relative h-[110vh] w-full flex items-center justify-start px-6 lg:px-20 bg-surface-lowest">
        ...
        <div className="relative z-10 max-w-5xl">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center">
              <Link to="/listing">
                <Button size="xl" variant="primary" className="group min-w-[240px]">
                  START IGNITION
                  <Zap size={18} className="ml-3 transition-transform duration-500 group-hover:scale-125" />
                </Button>
              </Link>
              <div className="w-full md:max-w-md relative group">
                <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-on-surface-variant group-focus-within:text-primary transition-all duration-500" size={20} />
                <input 
                  type="text"
        ...
        <div className="absolute bottom-32 right-12 lg:right-24 hidden lg:flex flex-col gap-12 text-right">
          {[
            ...
            >
              <div className="text-primary text-5xl font-poppins font-bold italic tracking-tighter transition-all duration-500 group-hover:tracking-normal">{stat.value}</div>
        ...
        <div className="flex justify-between items-end mb-16 px-4">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-poppins font-bold text-white tracking-tight uppercase">
              FEATURED <span className="text-on-surface-variant italic font-normal">CARS</span>
            </h2>
          </div>
          <Link to="/listing">
      ...
      <section className="py-24 px-6 lg:px-20 bg-surface-medium border-y border-white/5">
        ...
        <div className="flex flex-wrap justify-center gap-12 lg:gap-24">
          {[
            ...
            >
              <partner.icon className="text-primary transition-transform duration-500 group-hover:scale-110" size={32} />
              <span className="font-poppins font-bold text-2xl tracking-tighter text-white leading-none group-hover:tracking-normal transition-all duration-500">{partner.name}</span>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-12 md:p-16 bg-primary-gradient rounded-[2rem] text-background space-y-8 flex flex-col justify-end group overflow-hidden relative shadow-primary-glow/20 border border-white/10">
            ...
            <div className="z-10 space-y-4">
              <h4 className="text-3xl md:text-4xl font-poppins font-black uppercase leading-none">Precision <br/> Financing</h4>
          ...
          <div className="p-12 md:p-16 glass-card space-y-8 flex flex-col justify-end group">
            ...
            <div className="space-y-4">
              <h4 className="text-3xl font-poppins font-bold uppercase leading-none text-white">24/7 Concierge</h4>
      ...
      <section className="py-32 px-6 lg:px-20 bg-surface-lowest">
        <div className="mb-20 px-4">
          <h2 className="text-4xl md:text-5xl font-poppins font-bold text-white tracking-tight uppercase">
            DRIVER <span className="text-primary italic font-normal">VOICES</span>
          </h2>
        </div>
          ...
          {[
            ...
            >
              ...
              <div className="flex items-center gap-6 pt-6 border-t border-white/5">
                ...
                <div>
                  <div className="font-poppins font-bold text-lg uppercase tracking-tight text-white mb-0.5">{review.name}</div>
