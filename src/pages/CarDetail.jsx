  ...
  return (
    <div className="bg-background min-h-screen text-white overflow-x-hidden font-inter">
      ...
      <main className="relative z-20 px-6 md:px-20 lg:px-40 -mt-20 space-y-32 pb-48">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <div>
                <h4 className="text-on-surface-variant text-[0.6rem] font-poppins font-bold tracking-[0.3em] mb-3 opacity-40 uppercase">
                  {spec.label}
                </h4>
        ...
        <section className="grid lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5 space-y-10 pt-8">
            <div className="space-y-4">
              <span className="text-primary font-poppins font-bold text-[0.65rem] tracking-[0.5em] uppercase opacity-60">
                STRATEGIC INVESTMENT
              </span>
              <h3 className="text-5xl font-poppins font-bold tracking-tighter leading-none uppercase">
                OWNERSHIP <br />{" "}
            ...
            <div className="p-12 glass-effect rounded-[2.5rem] border border-white/10 space-y-8 relative overflow-hidden group">
              ...
              <div className="space-y-2">
                <span className="text-on-surface-variant text-[0.6rem] font-poppins font-bold tracking-[0.2em] opacity-50 uppercase">
                  MSRP STARTING AT
                </span>
              ...
              <p className="text-[0.9rem] text-on-surface-variant font-medium leading-relaxed opacity-70">
                Includes 4-year premium maintenance, 24/7 concierge trackside
                assistance, and global charging access for life.
              </p>
              <div className="pt-4">
                <Link to={`/booking?carName=${encodeURIComponent(car.name)}`}>
                  <Button className="w-full h-16 rounded-2xl" size="xl">
                    PROCURE VEHICLE
                  </Button>
                </Link>
              </div>
          ...
          <div className="lg:col-span-7 glass-card p-12 space-y-12">
            <div className="flex items-center gap-5">
              ...
              <h3 className="text-2xl font-poppins font-bold tracking-tight text-white uppercase">
            ...
            <div className="pt-12 border-t border-white/5 flex flex-wrap justify-between items-center gap-8">
              <div className="space-y-2">
                ...
                <div className="text-6xl font-poppins font-bold tracking-tighter text-white">
                  ...
                  <span className="text-sm font-medium text-on-surface-variant tracking-normal ml-3 opacity-40">
                    /MO
                  </span>
                </div>
              </div>
        ...
        <section className="space-y-20">
          <div className="text-center space-y-6">
            <span className="text-secondary font-poppins font-bold text-[0.65rem] tracking-[0.5em] uppercase opacity-60">
              MECHANICAL DATA
            </span>
            <h2 className="text-5xl font-poppins font-bold tracking-tighter text-white uppercase underline decoration-primary/30 underline-offset-[16px] decoration-2">
              PERFORMANCE <span className="text-white/40">TELEMETRY.</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-x-24 gap-y-4 max-w-6xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="flex justify-between items-center py-8 border-b border-white/5 group hover:border-primary/20 transition-all duration-500"
              >
                <span className="text-on-surface-variant text-[0.7rem] font-poppins font-bold tracking-[0.2em] opacity-40 group-hover:opacity-100 group-hover:text-primary transition-all uppercase">
                  {spec.label}
                </span>
                <span className="text-white font-poppins font-bold tracking-tight text-lg uppercase">
                  {spec.value}
                </span>
              </div>
            ))}
        ...
        <section className="space-y-16">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 border-b border-white/10 pb-12">
            <div className="space-y-5">
              ...
              <h2 className="text-5xl font-poppins font-bold text-white uppercase tracking-tighter">
                DRIVER <span className="text-white/40">INTELLIGENCE.</span>
              </h2>
            </div>
            <div className="flex items-center gap-6 glass-effect px-10 py-5 rounded-[2rem] border border-white/10">
              ...
              <span className="text-3xl font-poppins font-bold tracking-tighter">
                4.9<span className="text-sm opacity-40 ml-1">/5</span>
              </span>
            </div>
          </div>
            ...
            {[
              {
                name: "MARCUS V.",
                role: "TECH OPERATIVE",
                text: "The acceleration is absolute. It feels like warping through the kinetic grid in real-time.",
              },
              {
                name: "SARAH L.",
                role: "PRECISION DRIVER",
                text: "Finally a machine that doesn't just calculate speed, but manifests it through pure feedback.",
              },
              {
                name: "JASON D.",
                role: "ARCHITECT",
                text: "The interior geometry is a masterclass in minimalism and focus. Every touchpoint is deliberate.",
              },
            ].map((rev, i) => (
              <div
                key={i}
                className="p-12 glass-card space-y-10 relative overflow-hidden group hover:border-primary/30 transition-all duration-500"
              >
                ...
                <p className="text-xl font-medium text-white/90 leading-tight relative z-10">
                  "{rev.text}"
                </p>
                <div className="flex items-center gap-5 relative z-10 pt-8 border-t border-white/10">
                  ...
                  <div>
                    <div className="text-white font-poppins font-bold text-sm tracking-wide">
                      {rev.name}
                    </div>
                    <div className="text-[0.6rem] text-primary/60 font-poppins font-bold tracking-[0.2em] uppercase">
                      {rev.role}
                    </div>
                  </div>
                </div>
      ...
      <div className="fixed bottom-32 right-8 z-50 lg:hidden pointer-events-none">
        <Button
          className="pointer-events-auto rounded-full w-20 h-20 p-0 flex items-center justify-center shadow-luxury-float group"
          size="xl"
        >
          <ArrowRight
            size={32}
