  ...
  const hubs = [
    {
      ...
      address:
        "404 Kinetic Blvd, Neoverse Plaza, Sector 7G, San Francisco, CA 94105",
    ...
    <div className="bg-background text-white font-inter overflow-hidden pt-20">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          >
            <span className="text-primary font-poppins font-bold text-[0.65rem] tracking-[0.5em] uppercase text-sm">
          ...
          >
            ESTABLISH <br />{" "}
            <span className="text-primary drop-shadow-[0_0_30px_rgba(0,252,64,0.4)]">
              CONTACT
            </span>
          </motion.h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            <div className="flex items-center gap-6 mb-12">
              ...
              <h2 className="text-3xl font-poppins font-black uppercase tracking-tight text-white italic">
                SECURE INQUIRY
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[0.65rem] uppercase font-poppins font-bold tracking-[0.3em] text-primary ml-2 opacity-60">
                    Identity
                  </label>
                  <div className="relative">
                    ...
                    />
                    {errors.fullName && (
                      <p className="text-[10px] text-error font-bold uppercase tracking-widest mt-2 ml-2">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="Vehicle Configuration Inquiry">
                      Vehicle Configuration Inquiry
                    </option>
                    <option value="Performance Engineering Support">
                      Performance Engineering Support
                    </option>
                    <option value="Press & Media Access">
                      Press & Media Access
                    </option>
              ...
              >
                <div className="h-44 relative overflow-hidden backdrop-blur-md">
                  ...
                  <div className="absolute bottom-6 left-8">
                    <h3
                      className={`text-${hub.color} font-poppins font-black italic uppercase text-2xl tracking-tighter`}
                    >
                      HUB {hub.id}
                    </h3>
                  </div>
                ...
                <div className="p-8 space-y-6">
                  <p className="text-[0.65rem] uppercase font-poppins font-black tracking-[0.4em] text-primary">
                    {hub.title}
                  </p>
                  <p className="text-white/60 text-sm font-inter leading-relaxed uppercase opacity-80">
                    {hub.address}
                  </p>
          ...
          {[
            {
              ...
              desc: "Immediate priority assistance for existing kinetic owners.",
              color: "primary",
            },
            {
              icon: <Globe className="text-secondary" />,
              title: "Media Relations",
              desc: "Press kits, asset downloads, and global communications.",
              color: "secondary",
            },
            {
              icon: <BarChart3 className="text-white" />,
              title: "Investor Relations",
              desc: "Quarterly performance data and strategic roadmaps.",
              color: "white",
            },
          ].map((item, idx) => (
            <motion.div
            ...
            >
              ...
              <h4 className="text-2xl font-poppins font-black uppercase tracking-tight mb-4 italic">
                {item.title}
              </h4>
              <p className="text-white/60 text-xs font-inter font-bold uppercase tracking-widest mb-8 leading-relaxed">
                {item.desc}
              </p>
              <span
                className={`text-${item.color} font-poppins font-black text-[0.65rem] uppercase tracking-[0.4em] cursor-pointer hover:underline underline-offset-8 decoration-primary/30`}
              >
                Establish Link
              </span>
            </motion.div>
