        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-8">
            ...
            <p className="text-on-surface-variant text-[0.8rem] leading-relaxed max-w-xs font-inter font-medium">
              Redefining the automotive experience through digital excellence
              and curated luxury. Engineered precision, tailored for those who
              demand the peak of velocity.
            </p>
            <div className="flex gap-6">
              <Instagram
                className="text-on-surface-variant cursor-pointer hover:text-primary transition-all duration-300 hover:scale-110"
                size={18}
              />
              <Twitter
                className="text-on-surface-variant cursor-pointer hover:text-primary transition-all duration-300 hover:scale-110"
          ...
          {/* Quick Links */}
          <div className="space-y-8">
            <h3 className="text-[0.65rem] font-poppins font-bold text-white uppercase tracking-[0.25em]">
              Navigation
            </h3>
            <ul className="space-y-4">
              {["Home", "Listing", "Compare", "Wishlist", "Dashboard"].map(
                (item) => (
                  <li key={item}>
                    <Link
                      to={`/${item === "Home" ? "" : item.toLowerCase()}`}
                      className="text-on-surface-variant text-[0.75rem] font-poppins font-bold uppercase tracking-[0.1em] hover:text-primary transition-all duration-300 flex items-center gap-2 group"
                    >
